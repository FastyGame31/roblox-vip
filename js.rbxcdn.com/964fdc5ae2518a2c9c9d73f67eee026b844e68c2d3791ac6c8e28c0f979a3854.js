! function() {
    ...
    t.n = function(r) {
        ...
        function() {
            ...
            function R(r, e) {
                return (R = Object.setPrototypeOf || function(r, e) {
                    return r.__proto__ = e, r
                })(r, e)
            }
            ...
            var x = O(function(r) {
                var e = function(e) {
                    ...
                    function i(r) {
                        (function(r, e) {
                            if (!(r instanceof e)) throw TypeError("Cannot call a class as a function")
                        })(this, i), a = i, o = [r], a = H(a);
                        var e, t, n, a, o, g, u = (e = this, g = (t = G() ? Reflect.construct(a, o || [], H(this).constructor) : a.apply(this, o)) && ("object" == ((n = t) && "undefined" != typeof Symbol && n.constructor === Symbol ? "symbol" : typeof n) || "function" == typeof t) ? t : function(r) {
                            if (void 0 === r) throw ReferenceError("this hasn't been initialised - super() hasn't been called");
                            return r
            ...
            var rR = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__;

            function rG() {
                var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (!ra.document) {
                    rR && rp.error("Global document not defined in showReportDialog call");
                    return
                }
                var e = rW(),
                    t = e.getClient(),
                ...
                if (!n) {
                    rR && rp.error("DSN not configured for showReportDialog call");
                    return
                }
                ...
                u ? u.appendChild(a) : rR && rp.error("Not injecting report dialog. No injection point found in HTML")
            }
                ...
                rK = function(r) {
                    ...
                    function t(r) {
                        ...
                        return u && r.showDialog && (g._openFallbackReportDialog = !1, g._cleanupHook = u.on("afterSendEvent", function(e) {
                            !e.type && g._lastEventId && e.event_id === g._lastEventId && rG(rX(rY({}, r.dialogOptions), {
                    ...
                    return function(r, e) {
                            ...
                            value: function(r, e) {
                                ...
                                rj(function(i) {
                                    ...
                                    o && o(r, n, c), u && (t._lastEventId = c, t._openFallbackReportDialog && rG(rX(rY({}, b), {
                                        eventId: c
                                    }))), t.setState({
                                        error: r,
                                        componentStack: n,
                            ...
                            value: function() {
                                ...
                                return g.isValidElement(a) ? a : (t && rx && rp.warn("fallback did not produce a valid ReactElement"), null)
                            }
                        }],
                        function(r, e) {
                            for (var t = 0; t < e.length; t++) {
            ...
            a(["Roblox", "core-scripts", "react"], r), a("ReactUtilities", function(r) {
                for (var e = 1; e < arguments.length; e++) {
                    var t = null != arguments[e] ? arguments[e] : {},
                        n = Object.keys(t);
                    "function" == typeof Object.getOwnPropertySymbols && (n = n.concat(Object.getOwnPropertySymbols(t).filter(function(r) {
