    ...
    var s = function(e, n) {
            ...
            if ("string" == typeof e) r[e] = n;
                ...
                var t = function(e) {
                    ...
                    s = void 0;
                try {
                    for (var c, p = t[Symbol.iterator](); !(o = (c = p.next()).done); o = !0) {
                        var d, f = c.value;
                        null != (d = u)[f] || (d[f] = {}), u = u[f]
                    }
                } catch (e) {
                    a = !0, s = e
                } finally {
        ...
        b = function() {
            return y() && /rv[: ]\d+./.test(window.navigator.userAgent)
        },
        A = {
            android: "android",
            ios: "ios",
        ...
        g = function() {
            var e, n, r = d();
            return null == r ? null : {
                deviceType: r.deviceType && null != (e = p(w, r.deviceType)) ? e : "",
                appType: r.appType && null != (n = p(A, r.appType)) ? n : "",
        ...
        I = function() {
            var e;
            return (null == (e = S()) ? void 0 : e.isTestingSite) === "true"
        },
        h = function() {
