! function() {
    ...
    var a = function(r, e) {
        ...
        i = function() {
            ...
            function e(r, n, t) {
                ...
                this.namespace = t, this.resourceMap = n, this.intl = r
            }
            return r = [{
                    key: "get",
                    value: function(r, e) {
    ...
    var f = function() {
        ...
        }], r && s(n.prototype, r), e && s(n, e), n
    }();
    a(["Roblox", "core-scripts", "intl", "translation"], t), a(["Roblox", "TranslationResourceProvider"], f)
